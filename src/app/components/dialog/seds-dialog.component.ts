...
import type { SedsDialogRef } from './seds-dialog-ref';
import type { SedsDialogState } from './seds-dialog-state';
import { injectSedsDialogDefaultOptions } from './seds-dialog-token';
import { SedsDialogService } from './seds-dialog.service';

@Component({
	selector: 'seds-dialog',
	standalone: true,
	template: `
		<ng-content />
	`,
...
export class SedsDialogComponent {
	private readonly _dialogService = inject(SedsDialogService);
	...
	protected readonly _defaultOptions = injectSedsDialogDefaultOptions();
	...
	private readonly _dialogRef = signal<SedsDialogRef | undefined>(undefined);
	...
	public readonly stateChanged = output<SedsDialogState>();

	public readonly state = input<SedsDialogState | null>(null);

	public readonly role = input<SedsDialogOptions['role']>(this._defaultOptions.role);

	public readonly hasBackdrop = input(this._defaultOptions.hasBackdrop, { transform: booleanAttribute });

	public readonly positionStrategy = input<SedsDialogOptions['positionStrategy']>(this._defaultOptions.positionStrategy);
	...
	public readonly scrollStrategy = input<SedsDialogOptions['scrollStrategy'] | 'close' | 'reposition' | null>(
		this._defaultOptions.scrollStrategy,
	);

	protected _options = computed<Partial<SedsDialogOptions>>(() => {
	...
	public readonly restoreFocus = input<SedsDialogOptions['restoreFocus']>(this._defaultOptions.restoreFocus);
	...
	public readonly attachTo = input<SedsDialogOptions['attachTo']>(null);
	...
	public readonly attachPositions = input<SedsDialogOptions['attachPositions']>(this._defaultOptions.attachPositions);
	...
	public readonly autoFocus = input<SedsDialogOptions['autoFocus']>(this._defaultOptions.autoFocus);
	...
	public readonly ariaDescribedBy = input<SedsDialogOptions['ariaDescribedBy']>(null, {
	...
	public readonly ariaLabelledBy = input<SedsDialogOptions['ariaLabelledBy']>(null, { alias: 'aria-labelledby' });
	...
	public readonly ariaLabel = input<SedsDialogOptions['ariaLabel']>(null, { alias: 'aria-label' });
